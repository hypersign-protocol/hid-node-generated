...
export const Http = {
  ...
  fromJSON(object: any): Http {
    return {
      rules: globalThis.Array.isArray(object?.rules) ? object.rules.map((e: any) => HttpRule.fromJSON(e)) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<Http>, I>>(object: I): Http {
    const message = createBaseHttp();
    message.rules = object.rules?.map((e) => HttpRule.fromPartial(e)) || undefined;
...
export const HttpRule = {
  ...
  fromPartial<I extends Exact<DeepPartial<HttpRule>, I>>(object: I): HttpRule {
    ...
    message.additionalBindings = object.additionalBindings?.map((e) => HttpRule.fromPartial(e)) || undefined;
    return message;
  },
};
